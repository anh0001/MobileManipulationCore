...
For the default Piper config in this repo, `closed_position = 0.0` and `open_position = 0.065`, so:
- `gripper_command = 1.0` maps to `0.065` (fully open)
- `gripper_command = 0.0` maps to `0.0` (fully closed)
- `gripper_command = 0.996` maps to `0.06474` (effectively fully open)
